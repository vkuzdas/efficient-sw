...
//    Supplier<StringSet> testedSet = () -> new SynchronizedStringSet(1);
    ...
    @Test
    public void testMultipleIdenticalAddsRunner() throws InterruptedException {
        VmlensTestRunner runner = new VmlensTestRunner(testedSet);
        runner.initAdd("a");
    ...
    @Test
    public void testMultipleMultipleIdenticalAddsRunner() throws InterruptedException {
        VmlensTestRunner runner = new VmlensTestRunner(testedSet);
        runner.initAdd("a");
